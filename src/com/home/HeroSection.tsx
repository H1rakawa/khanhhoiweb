...
export default function HeroSection() {
  return (
    <section className="relative container mx-auto h-120">
      <div className="relative h-full mx-6 flex items-center overflow-hidden rounded-3xl">
        {/* Background Image */}
        <Image
        ...
        <div className="relative flex flex-col gap-5 z-10 text-center px-4 max-w-2xl mx-auto">
          ...
          <p className="text-white/85 text-base md:text-lg mb-8">
            ...
            <br /> thờ phượng Chúa và thông công vào Chúa Nhật hàng tuần lúc
            10:00 giờ sáng.
          </p>
